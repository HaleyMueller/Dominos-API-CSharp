...
namespace Dominos_API
{
    public static class Order
    {
        ...
        {
            string url = $"https://order.dominos.com/power/validate-order";
        ...
        {
            string url = $"https://order.dominos.com/power/place-order";

            var serial = Newtonsoft.Json.JsonConvert.SerializeObject(order);

            string html = WebRequestor.PostRequest(url, serial);
