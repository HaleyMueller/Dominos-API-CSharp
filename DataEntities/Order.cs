...
namespace Dominos_API.DataEntities
{
    ...
    public class OrderSubResponse : Order
    {
        ...
        public int PriceOrderMs
        {
            get; set;
        }

        public AmountsBreakdownClass AmountsBreakdown
        {
            get; set;
        } = new AmountsBreakdownClass();

        public List<StatusItemsClass> StatusItems
        {
            get; set;
        ...
        {
            public decimal FoodAndBeverage
            {
                get; set;
            }
    ...
    public class Order
    {
        ...
        public List<PaymentObject> Payments
        {
            get; set;
        } = new List<PaymentObject>();
        ...
        public Dictionary<string, string> Partners
        {
            get; set;
        } = new Dictionary<string, string>();

        public List<string> OrderInfoCollection
        {
            get; set;
        } = new List<string>();

        public LoyaltyClass Loyalty
        {
            get; set;
        }
        ...
        {
            public bool LoyaltyCustomer
            {
                get; set;
            }

            public bool CalculatePotentialPoints
            {
                get; set;
            }
        }
